...
echo '[goreportcard_badge]: https://goreportcard.com/badge/github.com/bruceesmith/set' >> temp2
echo '[goreportcard_link]: https://goreportcard.com/report/github.com/bruceesmith/set' >> temp2
